...
static const uint8_t offsets[] = {0,20,0,42};
///---Colors---///
/*0)focuscol         1)unfocuscol
 *2)fixedcol         3)unkilcol
 *4)fixedunkilcol    5)outerbordercol
 *6)emptycol         */
static const char *colors[] = {"#84a0c6","#c6c8d1","#181818","#ff6666","#cc9933","#282c34","#282c34"};
...
static const uint8_t borders[] = {5,7,2,4};
...
static const char *termm[]   = { "st", NULL };
static const char *xi[] ={"xbacklight","-inc","8", NULL};
static const char *xd[] ={"xbacklight","-dec","8", NULL};
static const char *sss[] ={"rofi-screenshot",NULL};
///--Custom foo---///
...
static key keys[] = {
    ...
    // Start programs
    {  MOD,              XK_Return,          start,             {.com = termm}},
    {  MOD,              XK_w,               start,             {.com = rofi}},
    {  MOD,              XK_z,           start,             {.com = xi}},
    {  MOD|SHIFT,       XK_space,           start,             {.com = xd}},
    {  MOD|CONTROL,       XK_u,           start,             {.com = sss}},
...
static Button buttons[] = {
    ...
    {  0,XCB_BUTTON_INDEX_3,     start,         {.com = termm}, true},

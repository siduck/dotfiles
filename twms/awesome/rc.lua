...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ " ", " ", "亂 "," ", " "}, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, }, "c", function () awful.util.spawn("rofi -show drun") end),
     awful.key({modkey, }, "z", function () awful.util.spawn("scrot /home/sid/Pictures/ss/") end),
     awful.key({  }, "Print", function () awful.util.spawn_with_shell("maim | xclip -selection clipboard -t image/png") end),
     awful.key({ modkey, }, "u", function () awful.util.spawn_with_shell ("maim --select | xclip -selection clipboard -t image/png") end),
